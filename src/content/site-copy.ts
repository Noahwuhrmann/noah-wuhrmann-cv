...
export const siteCopy: Record<Language, SiteCopy> = {
  de: {
    ...
    skills: {
      ...
      visualHint:
        "Die Nummern 01-10 verweisen auf die Detailkarten darunter.",
      toolLabel: "Werkzeuge",
      toolTitle: "Stack für klare Umsetzung",
      toolGroups: [
        {
          title: "Daten und Analyse",
          items: ["Python", "R", "Excel"],
        },
        {
        ...
        },
        {
          ...
          items: ["SAP", "Reporting", "Projektplanung", "Dokumentation"],
        },
        {
          title: "Gestaltung und Präsentation",
          items: ["PowerPoint", "Word", "Canva"],
        },
        {
          title: "KI und Assistenzsysteme",
          items: ["ChatGPT", "Codex", "Claude", "Prompting", "KI-gestützte Recherche"],
        },
      ],
      ...
      items: [
        {
          ...
          body: "Mehrjährige Praxiserfahrung im Sportartikelhandel mit Verständnis für Filialalltag, Kundenbedürfnisse, Verkauf, Warenbewirtschaftung und operative Verantwortung.",
          level: 4,
          tags: ["Praxis", "Verkauf", "Kundenfokus"],
        },
        {
          title: "Analytisches Denken",
          body: "Strukturierte Analyse von Zahlen, Prozessen und Problemstellungen mit Fokus auf verständliche Auswertungen und fundierte Entscheidungen.",
          level: 4,
          tags: ["Analyse", "Zahlenverständnis", "Struktur"],
        },
        {
          title: "Prozessoptimierung",
          body: "Erkennen von ineffizienten Abläufen und Entwicklung praxisnaher Verbesserungen, insbesondere durch Automatisierung, klare Strukturen und digitale Unterstützung.",
          level: 4,
          tags: ["Optimierung", "Automatisierung", "Effizienz"],
        },
        {
          title: "Datenbasierte Entscheidungsfindung",
          body: "Aufbereitung, Interpretation und Visualisierung von Daten, um operative und wirtschaftliche Entscheidungen nachvollziehbar zu unterstützen.",
          level: 4,
          tags: ["Daten", "Reporting", "Kennzahlen"],
        },
        {
          title: "Projektorientierte Arbeitsweise",
          body: "Planung, Strukturierung und Dokumentation von Projekten mit Blick auf Ziele, Meilensteine, Risiken, Ressourcen und konkrete Umsetzung.",
          level: 4,
          tags: ["Projektlogik", "Planung", "Umsetzung"],
        },
        {
          title: "Digitale Umsetzungskompetenz",
          body: "Praktische Anwendung digitaler Werkzeuge zur Umsetzung eigener Lösungen, beispielsweise für Datenaufbereitung, Reporting, Automatisierung und Visualisierung.",
          level: 3,
          tags: ["Tools", "Digitalisierung", "Umsetzung"],
        },
        {
          title: "KI-gestützte Arbeitsweise",
          body: "Gezielter Einsatz von KI-Tools zur Ideenentwicklung, Textüberarbeitung, Rechercheunterstützung, Strukturierung von Inhalten und effizienteren Umsetzung von Aufgaben.",
          level: 4,
          tags: ["KI", "Effizienz", "Strukturierung"],
        },
        {
          title: "Kommunikation und Präsentation",
          body: "Verständliche Aufbereitung komplexer Inhalte für Berichte, Präsentationen, Kundengespräche und die Zusammenarbeit mit unterschiedlichen Anspruchsgruppen.",
          level: 4,
          tags: ["Präsentation", "Beratung", "Verständlichkeit"],
        },
        {
          title: "Englisch",
          body: "Solide Englischkenntnisse für Studium, Fachtexte, Bewerbungsunterlagen und die grundlegende Kommunikation in einem internationalen Arbeitsumfeld.",
          level: 3,
          tags: ["Englisch", "Fachtexte", "Kommunikation"],
        },
        {
          title: "Selbstständige Arbeitsweise",
          body: "Zuverlässige, lernbereite und verantwortungsbewusste Arbeitsweise mit hoher Eigeninitiative und lösungsorientiertem Vorgehen.",
          level: 4,
          tags: ["Eigeninitiative", "Verantwortung", "Lernen"],
        },
      ],
    },
    projects: {
  ...
  en: {
    ...
    skills: {
      ...
      visualHint:
        "The numbers 01-10 refer to the detailed cards below.",
      toolLabel: "Tools",
      ...
      toolGroups: [
        ...
        },
        {
          ...
          items: ["SAP", "Reporting", "Project planning", "Documentation"],
        },
        {
        ...
        {
          title: "AI and assistance systems",
          items: ["ChatGPT", "Codex", "Claude", "Prompting", "AI-supported research"],
        },
      ],
      ...
      items: [
        {
          ...
          body: "Several years of practical experience in sports retail with understanding of store operations, customer needs, sales, merchandise management and operational responsibility.",
          level: 4,
          tags: ["Practice", "Sales", "Customer focus"],
        },
        {
          title: "Analytical thinking",
          body: "Structured analysis of numbers, processes and problems with a focus on clear evaluations and well-founded decisions.",
          level: 4,
          tags: ["Analysis", "Numeracy", "Structure"],
        },
        {
          title: "Process optimization",
          body: "Identifying inefficient workflows and developing practical improvements, especially through automation, clear structures and digital support.",
          level: 4,
          tags: ["Optimization", "Automation", "Efficiency"],
        },
        {
          title: "Data-based decision-making",
          body: "Preparing, interpreting and visualizing data to support operational and business decisions in a clear and traceable way.",
          level: 4,
          tags: ["Data", "Reporting", "Metrics"],
        },
        {
          title: "Project-oriented working style",
          body: "Planning, structuring and documenting projects with attention to goals, milestones, risks, resources and concrete implementation.",
          level: 4,
          tags: ["Project logic", "Planning", "Execution"],
        },
        {
          title: "Digital implementation competence",
          body: "Practical use of digital tools to implement own solutions, for example in data preparation, reporting, automation and visualization.",
          level: 3,
          tags: ["Tools", "Digitalization", "Implementation"],
        },
        {
          title: "AI-supported working style",
          body: "Targeted use of AI tools for idea development, text revision, research support, content structuring and more efficient task execution.",
          level: 4,
          tags: ["AI", "Efficiency", "Structuring"],
        },
        {
          title: "Communication and presentation",
          body: "Clear preparation of complex content for reports, presentations, customer conversations and collaboration with different stakeholders.",
          level: 4,
          tags: ["Presentation", "Consulting", "Clarity"],
        },
        {
          title: "English",
          body: "Solid English skills for studies, specialist texts, application documents and basic communication in an international working environment.",
          level: 3,
          tags: ["English", "Specialist texts", "Communication"],
        },
        {
          title: "Independent working style",
          body: "Reliable, eager-to-learn and responsible way of working with strong initiative and a solution-oriented approach.",
          level: 4,
          tags: ["Initiative", "Responsibility", "Learning"],
        },
      ],
    },
    projects: {
